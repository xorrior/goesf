...
NSString* event_type_str(const es_event_type_t event_type) {
    ...
    // this is the function that contains the event types to be used
    switch(event_type) {
